...
image_name = '171206_033358756_Camera_5'
...
with tf.Session() as sess:
    ...
    # visualization.visualize_segmentation(origin_image[0], seg_image)
    ...
    # visualization.show_patches(origin_image_patches)
    ...
    prediction = preprocess_input.filter_classes(prediction, class_indices=[3, 7])


    model_path = tf.train.latest_checkpoint('tmp/train_03_reg_log_dir/')
